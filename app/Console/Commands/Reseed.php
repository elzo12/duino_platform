...
class Reseed extends Command
{
    ...
    public function handle()
    {
        ...
        File::copy(storage_path('app/public/pictures-seed/margot.jpg'), storage_path('app/public/pictures/margot.jpg'));
        File::copy(storage_path('app/public/pictures-seed/face-6.jpg'), storage_path('app/public/pictures/face-6.jpg'));
        File::copy(storage_path('app/public/pictures-seed/face-5.jpg'), storage_path('app/public/pictures/face-5.jpg'));
    }
}
